var app = {
  ...
  pintaCoordenadasEnMapa: function(position){
	...
	var token_mapbox = 'pk.eyJ1IjoiY2FybGdhcnBlbCIsImEiOiJjaXllZGJnYngwMHlzMzNzeDA2eHZqMWFqIn0.4e7eKpqTLdCZXlnhHY1VTQ';
    ...
    app.pintaMarcador([position.coords.latitude, position.coords.longitude], '¡Estás aquí! ' + position.coords.latitude.toFixed(2) + " " +  position.coords.longitude.toFixed(2), true);
	...
	var watchID = navigator.geolocation.watchPosition(app.updateLocation, app.errorAlSolicitarLocalizacion, {timeout: 80000});
  },
  ...
  updateLocation: function(position){
	  app.pintaMarcador([position.coords.latitude, position.coords.longitude], '¡Estás aquí! ' +
     position.coords.latitude.toFixed(2) + " Altitud: " +  position.coords.longitude 
      , true);
  }
};
